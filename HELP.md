...
* The original package name 'com.vickllny.distributed-cache' is invalid and this project uses 'com.vickllny.distributedcache' instead.
...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/docs/2.7.18-SNAPSHOT/reference/htmlsingle/index.html#appendix.configuration-metadata.annotation-processor)
